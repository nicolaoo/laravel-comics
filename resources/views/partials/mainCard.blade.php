<header>
    ...
    $comics = [
        ...
        [
            ...
            "thumb" => "https://th.bing.com/th/id/R.0134c2309028a66580d84fd900351413?rik=WyO36sPpGn2Dpw&pid=ImgRaw&r=0",
            "price" => "$4.99",
    ...
    <main>
        <section>
            <div>
                <figure class="mb-0">
                    <img class="jumbo-img" src="{{ Vite::asset('resources/images/jumbotron.jpg') }}" alt="">
                </figure>
            </div>
            <div class="row-blue-main">
                <div class="container">
                    <figure>
                        <img src="{{ Vite::asset('resources/images/SUPERMAN.jpg') }}" alt="">
                    </figure>
                </div>
            </div>
